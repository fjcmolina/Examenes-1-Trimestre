 ...
 *       se pueden romper aunque haya huecos sueltos suficientes. El funcionamiento del programa se ilustra a
 *       continuación:
 */
package ejercicio4;
 ...
 int[] mesa = new int[10];
    ...
    do {
      ...
      if (clientes > 4) { // comprueba si el grupo de clientes es mayor a 4
        System.out.print("\nLo siento, no admitimos grupos de 6, haga grupos de");
        ...
        if (hayMesaVacia) {
          ...
          System.out.println("\n Por favor, siéntense en la mesa número " + (iVacia + 1) + ".");
        } else {
